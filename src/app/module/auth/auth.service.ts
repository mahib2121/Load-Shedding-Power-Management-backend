...
import { UserRole, UserStatus, type JobType } from "../../../generated/prisma/enums";
 ...
 * Logout
 *
 * JWT-based authentication does not require a database operation here.
 * The client should remove the access/refresh tokens.
 */
 ...
 * Create system user.
 *
 * This should normally be used by SUPER_ADMIN or seed scripts.
 */
...
const googleLogin = async (payload: IGoogleLoginPayload) => {
	...
	if (!user) {
		...
		if (existingEmailUser) {
			 ...
			 *
			 * IMPORTANT:
			 * We cannot automatically assign an area here
